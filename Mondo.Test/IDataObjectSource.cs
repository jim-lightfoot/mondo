...
namespace Mondo.Test
{
    ...
    {
        [TestMethod]
        public void IDataObjectSource_ToObject()
        {
        ...
        [TestMethod]
        public void IDataObjectSource_ToObject2()
        {
            string xml = "<Data><Make>Aston Martin</Make><Model>DB9</Model><Year>1965</Year><Color>Blue</Color></Data>";
            XmlDocument xmlDoc = XmlDoc.LoadXml(xml);
            IDataObjectSource ds = DataObjectSource.Create(xmlDoc.RootNode());
        ...
        [TestMethod]
        public void IDataObjectSource_ToObject3()
        {
        ...
        [TestMethod]
        public void IDataObjectSource_ToList()
        {
        ...
        [TestMethod]
        public void IDataObjectSource_Dynamic()
        {
            string xml = "<Data><Make>Aston Martin</Make><Model>DB9</Model><Year>1965</Year><Color>Blue</Color></Data>";
            XmlDocument xmlDoc = XmlDoc.LoadXml(xml);
        ...
        [TestMethod]
        public void IDataObjectSource_Dynamic2()
        {
        ...
        [TestMethod]
        public void IDataObjectSource_DynamicDataTable()
        {
